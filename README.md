...
## CNN LSTM Model for converting hand-written text into machine-encoded (Digital) text
**Publication**
...
## Customer churn prediction model for a General Insurance company using ensemble ML modelling techniques
**Publication**
